...
export type InsertBreadEntryMutationVariables = Exact<{
  object: BreadEntriesInsertInput;
}>;


export type InsertBreadEntryMutation = { __typename?: 'mutation_root', insertBreadEntriesOne?: { __typename?: 'BreadEntries', id: any, overallScore: any, overallConfidence: any, expertGuidance: string, expertGuidanceConfidence: any, pros: string, prosConfidence: any, cons: string, consConfidence: any, crumbStructure: string, crumbStructureDescription: string, crumbStructureConfidence: any, textureDescription: string, textureConfidence: any, holeDistributionDescription: string, holeDistributionConfidence: any, crustCrumbDescription: string, crustCrumbConfidence: any, hasLargeHolesNearTop: boolean, hasSeparation: boolean, isGummyOrDense: boolean, isHoleDistributionEven: boolean, isLightAndAiry: boolean, isWellBonded: boolean, notes: string, createdAt: any, updatedAt: any, hasValidImage: boolean, validImageConfidence: any, images: Array<{ __typename?: 'BreadEntryImages', id: any, imagePath: string, imageName: string, originalImageName: string }> } | null };

export type InsertChatMessageAiMutationVariables = Exact<{
  ...
  frequencyPenalty?: InputMaybe<Scalars['numeric']['input']>;
  presencePenalty?: InputMaybe<Scalars['numeric']['input']>;
  createdByUserId: Scalars['uuid']['input'];
}>;


export type InsertChatMessageAiMutation = { __typename?: 'mutation_root', insertChatMessagesOne?: { __typename?: 'ChatMessages', id: any, content: string, role: string, createdAt: any, updatedAt: any } | null };

export type InsertChatMessageUserMutationVariables = Exact<{
  id: Scalars['uuid']['input'];
  ...
  content: Scalars['String']['input'];
  promptTokens?: InputMaybe<Scalars['Int']['input']>;
  files?: InputMaybe<Array<ChatMessageFilesInsertInput> | ChatMessageFilesInsertInput>;
  isMedical?: InputMaybe<Scalars['Boolean']['input']>;
  isMedicalConfidence?: InputMaybe<Scalars['numeric']['input']>;
}>;


export type InsertChatMessageUserMutation = { __typename?: 'mutation_root', insertChatMessagesOne?: { __typename?: 'ChatMessages', id: any, content: string, role: string, createdAt: any, updatedAt: any } | null, insertChatMessageFiles?: { __typename?: 'ChatMessageFilesMutationResponse', returning: Array<{ __typename?: 'ChatMessageFiles', id: any }> } | null };
...
export type InsertNewUserMutation = { __typename?: 'mutation_root', insertUsersOne?: { __typename?: 'Users', id: any } | null };

export type UpdateBreadEntryTrendAnalysisMutationVariables = Exact<{
  id: Scalars['uuid']['input'];
  trendAnalysis: Scalars['String']['input'];
}>;


export type UpdateBreadEntryTrendAnalysisMutation = { __typename?: 'mutation_root', updateBreadEntriesByPk?: { __typename?: 'BreadEntries', id: any, trendAnalysis?: string | null } | null };
...
export type UpdateChatTitleMutation = { __typename?: 'mutation_root', updateChatThreadsByPk?: { __typename?: 'ChatThreads', id: any, title: string } | null };

export type UpsertInitializeChatThreadMutationVariables = Exact<{
  id: Scalars['uuid']['input'];
  createdByUserId: Scalars['uuid']['input'];
  breadEntryId?: InputMaybe<Scalars['uuid']['input']>;
}>;
...
export type UpsertInitializeChatThreadMutation = { __typename?: 'mutation_root', insertChatThreadsOne?: { __typename?: 'ChatThreads', id: any, title: string, createdAt: any, updatedAt: any, userId: any, breadEntry?: { __typename?: 'BreadEntries', id: any, analysis: string, message: string, notes: string, summary: string, trendAnalysis?: string | null, images: Array<{ __typename?: 'BreadEntryImages', imagePath: string, id: any, imageName: string, mimeType: string, size: number, originalImageName: string }>, recipe?: { __typename?: 'Recipes', id: any, flour: string, ingredients: string, instructions: string, name: string, remarks: string, salt: string, water: string } | null } | null } | null };

export type GetBreadEntriesForTrendAnalysisQueryVariables = Exact<{
  userId: Scalars['uuid']['input'];
  crumbId: Scalars['uuid']['input'];
}>;


export type GetBreadEntriesForTrendAnalysisQuery = { __typename?: 'query_root', breadEntry?: { __typename?: 'BreadEntries', archivedAt?: any | null, cons: string, consConfidence: any, createdAt: any, expertGuidance: string, expertGuidanceConfidence: any, id: any, hasValidImage: boolean, validImageConfidence: any, notes: string, overallConfidence: any, overallScore: any, pros: string, prosConfidence: any, recipeId?: any | null, updatedAt: any, summary: string, userId: any, images: Array<{ __typename?: 'BreadEntryImages', id: any, imagePath: string, imageName: string }> } | null, recentEntries: Array<{ __typename?: 'BreadEntries', archivedAt?: any | null, cons: string, consConfidence: any, createdAt: any, expertGuidance: string, expertGuidanceConfidence: any, id: any, hasValidImage: boolean, validImageConfidence: any, notes: string, overallConfidence: any, overallScore: any, pros: string, prosConfidence: any, recipeId?: any | null, updatedAt: any, summary: string, images: Array<{ __typename?: 'BreadEntryImages', id: any, imagePath: string, imageName: string }> }> };

export type GetCheckUserExistsQueryVariables = Exact<{
  email: Scalars['String']['input'];
}>;


export type GetCheckUserExistsQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'Users', id: any, name: string, email: string }> };
...
export type GetViewerByIdQuery = { __typename?: 'query_root', usersByPk?: { __typename?: 'Users', createdAt: any, email: string, id: any, name: string } | null };
